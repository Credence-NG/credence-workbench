...
export interface ResendCredentialResponse {
  credentialRequestId: string;
  originalRequestNumber: string;
  status: string;
  resentAt: string;
  method: "connection" | "out-of-band";
  credentialType: "INDY" | "JSONLD";
}

export interface ResendCredentialHook {
  resendCredential: (credentialRequestId: string) => Promise<void>;
  isLoading: boolean;
  error: string | null;
  success: ResendCredentialResponse | null;
  clearMessages: () => void;
}
