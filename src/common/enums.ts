...
// Note: Regulators are now dynamically loaded from the backend API
// via getRegulators(countryId) function instead of hardcoded enum.
// This allows for better scalability and support for multiple countries.
