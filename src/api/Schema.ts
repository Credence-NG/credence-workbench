...
} from "../components/Resources/Schema/interfaces";
...
export const getAllSchemas = async (
  ...
  console.log("🔍 [getAllSchemas API] Request URL:", details.url);

  try {
    const response = await axiosGet(details);
    console.log("✅ [getAllSchemas API] Response:", response);
    return response;
  } catch (error) {
    const err = error as Error;
    console.error("❌ [getAllSchemas API] Error:", error);
